<div class="tw-flex tw-flex-col tw-items-end tw-fixed tw-right-[10px] tw-top-[75%] tw-gap-y-3">
  <button
    ...
    id="offer-btn">
    <div
      class="tw-absolute tw-origin-left tw-left-[13px] tw-top-1/2 tw-transform tw--translate-y-1/2 tw-flex tw-flex-row tw-justify-center tw-items-center tw-gap-x-2">
