        ...
        <div class="col-xs-12">
            ...
            <form action="/test/push-noti" class="form col-xs-12 col-md-4" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="body" class="form-control" id="body" rows="6" placeholder="Write multiline text or Bangla text"></textarea>
                </div>

                <div class="form-group">
                    <label for="large_icon">Large Icon</label>
                    <input type="text" value="" name="large_icon" class="form-control" id="large_icon" placeholder="Large Icon Url" />
                </div>
                <div class="form-group">
                    <label for="banner_url">Notification Title</label>
                    <input type="text" value="" name="banner_url" class="form-control" id="banner_url" placeholder="Banner Url" />
                </div>
