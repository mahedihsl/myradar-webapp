<div
  ...
  <div class="tw-flex tw-flex-col tw-gap-y-2">
    <span class="tw-text-gray-700 tw-font-medium tw-text-2xl">{{ $lead->name }}</span>
    ...
    <p class="tw-text-xl tw-text-gray-600 tw-font-normal tw-mt-4">
      {{ $lead->message or '--' }}
    </p>
  </div>

  <div class="tw-flex tw-flex-col tw-gap-y-2">
    <span class="tw-text-gray-700 tw-text-lg tw-font-medium">
      <i class="fa fa-calendar"></i> {{ $lead->created_at->toDayDateTimeString() }}
    </span>
    <span class="tw-text-gray-700 tw-text-lg tw-font-semibold">
