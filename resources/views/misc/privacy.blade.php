...
<body>
    ...
    <p> Hyper Systems Ltd. built the myRADAR app as a Commercial app. This SERVICE is provided by
        Hyper Systems Ltd. and is intended for use as is.
    </p>
    ...
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
        accessible at myRADAR unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>For a better experience, while using our Service, we may require you to provide us with certain
        personally identifiable information, including but not limited to FCM device token, User location, Phone &amp; Call, Email Address. The information that we request will be retained by us and used as described in this privacy policy.
    </p>
