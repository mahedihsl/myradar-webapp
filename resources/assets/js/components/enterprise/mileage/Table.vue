<template>
  <div class="col-xs-12 table-responsive">
    ...
    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="margin-bottom:2%">
      <a class="btn btn-primary pull-right" :href="'/mileage/export?id='+userId+'&m='+time.m+'&y='+time.y"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export</a>
    </div>
    ...
    <table class="table table-striped table-hover">
      <thead class="colored-header">
        <tr>
          ...
          <th class="col-sm-2 clickable" @click="changeDistSort">
            Mileage <i class="fa" :class="distSortIcon"></i>
          </th>
...
export default {
  ...
  computed: {
    ...mapGetters('mileage', ['cars', 'distSort', 'loading', 'time']),
    filteredList() {
      return this.cars(this.search, this.compare, this.value);
    },
    distSortIcon() {
      return ['fa-sort-desc', 'fa-sort', 'fa-sort-asc'][this.distSort + 1];
    },

  },
  methods: {
    ...mapMutations('mileage', ['changeDistSort', 'setTime']),
    ...mapActions('mileage', ['getCars']),
  }
}
</script>
