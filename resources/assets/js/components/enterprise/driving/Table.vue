<template>
  <div class="col-xs-12 table-responsive">
    ...
    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2" style="margin-bottom:2%">
      <a class="btn btn-primary pull-right" :href="'/driving/hour/export?id='+userId+'&m='+time.m+'&y='+time.y"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Export</a>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters('driving', ['cars', 'timeSort', 'loading', 'time']),
    filteredList() {
  ...
  methods: {
    ...mapMutations('driving', ['setTimeSort', 'setTime']),
    ...mapActions('driving', ['getCars', 'getExportData']),
