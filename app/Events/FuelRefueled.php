...
class FuelRefueled
{
    ...
    public function isDeliverable(){
      $factor = $this->device->car->meta_data->get('fuel_factor');
    ...
    public function body()
    {
        if($this->body == null){
          ...
          $factor = $this->device->car->meta_data->get('fuel_factor');
          $tunefactor = $this->device->car->meta_data->get('fuel_tune_factor');

          $phone = '+880 1907888839';
          $this->body = "Your car has taken fuel at {$time}.\nTo know your gas amount please call {$phone}";
          ...
          if ($factor['status']) {
              ...
              $price = round($price);
              $this->body = "Your car has taken fuel of {$price} Taka at {$time}";
          }
