...
class GasRefueledByFiltering
{
    ...
    public function isPublic()
    {
        ...
        return 1;
        // $notifiable = $this->device->car->meta_data->get('gas_factor')['status'];
        // return $subscribed && $notifiable;
    }
    ...
    {
        if($this->title == null){
          $this->title = "Alert for car: {$this->device->car->reg_no}   By Filtering Method";
        }
    ...
    public function body()
    {
        if($this->body == null){
          ...
          $this->body = "Your car has taken gas at {$time}.\nTo know your gas amount please call {$phone} By Filtering Method";
          ...
          if ($factor['status']) {
              ...
              $price = round($price);
              $this->body = "Your car has taken gas of {$price} Taka at {$time} By Filtering Method";
          }
